...
typedef struct __align__(8) bfloat164
{
    ...
    __device__ bfloat164(__hip_bfloat162 x_, __hip_bfloat162 y_): x(x_), y(y_) {}
    __device__ bfloat164(__hip_bfloat16 b0, __hip_bfloat16 b1, __hip_bfloat16 b2, __hip_bfloat16 b3) :
...
inline void cublas_assert(hipblasStatus_t code, const char *file, int line, bool abort=true)
{
