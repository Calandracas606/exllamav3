...
# New upstream CUDA-specific kernels (dsv4, dsa, hc_mix, bighead attention variants)
# and their libtorch wrappers are also excluded since their bindings are guarded
# with #if !defined(USE_ROCM) and they use APIs not portable to HIP.
ROCM_EXCLUDE_FILES = {
